        ...
        'fixture', jsonb_build_object(
            ...
            'run', (
                SELECT jsonb_build_object(
                    ...
                    'client_request_id', to_jsonb(run)->'client_request_id',
                    'create_request_digest', to_jsonb(run)->'create_request_digest',
                    'create_request_version', to_jsonb(run)->'create_request_version',
